...
ENV PRAGMA_CHIPS="something for gaming|make fresh coffee at home|comfortable chair for long workdays|fast storage for my pc|wireless noise cancelling headphones"
